...
//        Image icon= new Toolkit.getDefaultToolkit().getImage(ClassLoader.getSystemResource("img/logo.png"));
    ...
    private void initComponents() {
        ...
        jLabel10.setText("DE CUENTAS");
        btncatalogo.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, 100, 20));

        jLabel11.setFont(new java.awt.Font("Segoe UI", 1, 10)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel11.setText("CATÁLOGO");
        btncatalogo.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 100, 20));
    ...
    private void btndiarioMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btndiarioMouseExited
        if (this.btncatalogo.getBackground().getRGB() != -15574355)
    ...
    private void btndiarioMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btndiarioMousePressed
        ...
        // Abrir sección
        jpLibroDiario panelLibroDiario = new jpLibroDiario();
